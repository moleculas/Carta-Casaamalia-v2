...
const Vins = (props) => {
    ...
    useEffect(() => {
        if (laDataVins) {
            ...
            dispatch(obtenerDatosInicial("vins"));
            forceUpdate();
        };
    }, [laDataVins]);
        ...
        <div>
            ...
            <Grid container spacing={2}>
                <Grid item xs={12}>
                    ...
                    >
                        <Typography variant="h5">{cartaGeneral?.nom_vins_ca}</Typography>
                        {cartaGeneral && (
                            <Chip
                        ...
                        <div className={classes.root2}>
                            <AppBar position="static" color={cartaGeneral?.tipus === "nadal" ? "custom" : "primary"}>
                                <Tabs
                                    ...
                                    textColor="inherit"
                                >
                                    <Tab label={titolsVins[0][`titol_ca`]} {...a11yProps(0)} />
